...
# MAGIC %md
# MAGIC # 1) Create Gen 2 Storage Account

# COMMAND ----------

# MAGIC %md
# MAGIC - After creating Gen 2 Storage Account (gen2storage05)
# MAGIC - Create a new container as, "retail-org" in that storage account
# MAGIC - Inside this container create 2 folders, "customers" and "sales_orders"
# MAGIC - inside these 2 directories, upload respective files

# COMMAND ----------

# MAGIC %md
# MAGIC # 2) Mount storage container
