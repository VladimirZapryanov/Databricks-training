...
-- MAGIC %md
-- MAGIC # 1) Bronze Datasets: Ingesting the dataset using Cloud Files
...
AS SELECT * FROM cloud_files("/mnt/retail-org/customers/", "csv");
...
AS
SELECT * FROM cloud_files("/mnt/retail-org/sales_orders/", "json", map("cloudFiles.inferColumnTypes", "true"));

-- COMMAND ----------

-- MAGIC %md
-- MAGIC # 2) Silver Datasets: Expectations and high-quality data 
...
-- MAGIC %md
-- MAGIC # 3) Gold data sets: complete vs streaming / continuous vs triggered
